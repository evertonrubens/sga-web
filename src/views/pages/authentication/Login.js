...
const ToastContent = ({ name, role }) => (
  <Fragment>
    ...
    <div className='toastify-body'>
      <span>Oba! Você logou com sucesso como um usuário {role} na plataforma SGA. Agora, você pode começar a explorar. Aproveite esta jornada!</span>
    </div>
  </Fragment>
)
...
const Login = props => {
  ...
  const [email, setEmail] = useState('engeverton@gmail.com')
    ...
    if (isObjEmpty(errors)) {
      useJwt
        ...
        .then(res => {
          ...
          toast.success(
            <ToastContent name={data.fullName || data.username || 'Everton'} role={data.role || 'admin'} />,
    ...
    <div className='auth-wrapper auth-v2'>
      <Row className='auth-inner m-0'>
        <Link className='brand-logo' to='/' onClick={e => e.preventDefault()}>
          <svg viewBox='0 0 119 74' version='1.1' height='28'>
            <defs>
        ...
        <Col className='d-flex align-items-center auth-bg px-2 p-lg-5' lg='4' sm='12'>
          <Col className='px-xl-2 mx-auto' sm='8' md='6' lg='12'>
            <CardTitle tag='h2' className='font-weight-bold mb-1'>
              Seja bem vindos ao Gestor de Autos! 👋
            </CardTitle>
            <CardText className='mb-2'>Faça login na sua conta e comece a gerenciar seus Autos</CardText>
            ...
            <Form className='auth-login-form mt-2' onSubmit={handleSubmit(onSubmit)}>
              ...
              <FormGroup>
                <CustomInput type='checkbox' className='custom-control-Primary' id='remember-me' label='Lembre-me' />
              </FormGroup>
            ...
            <p className='text-center mt-2'>
              <span className='mr-25'>Você é novo na Plataforma?</span>
              <Link to='/register'>
                <span>Então, crie a sua conta</span>
              </Link>
            </p>
