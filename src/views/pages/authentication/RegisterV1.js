    ...
    return (
      <Fragment>
        ...
        <a className='ml-25' href='/' onClick={e => e.preventDefault()}>
          as políticas de privacidade e termos.
        </a>
      </Fragment>
    )
  }
        ...
        <Card className='mb-0'>
          <CardBody>
            ...
            <CardTitle tag='h4' className='mb-1'>
              A gestão de sua empresa começa aqui 🚀
            </CardTitle>
            <CardText className='mb-2'>Torne a gestão da sua empresa fácil e ao mesmo tempo precisa!</CardText>
            <Form className='auth-register-form mt-2' onSubmit={e => e.preventDefault()}>
              <FormGroup>
                <Label className='form-label' for='register-username'>
                  Usuário
                </Label>
                <Input type='text' id='register-username' placeholder='Rubens' autoFocus />
              </FormGroup>
              <FormGroup>
                <Label className='form-label' for='register-email'>
                  Email
                </Label>
                <Input type='email' id='register-email' placeholder='rubens@gmail.com' />
              </FormGroup>
              <FormGroup>
            ...
            <p className='text-center mt-2'>
              <span className='mr-25'>Você já tem uma conta?</span>
