...
export const basicData = [
    ...
    customContent: (
      <Media className='align-items-center'>
        ...
        <Media className='ml-50' body>
          <h6 className='mb-0'>Everton Martins (Client)</h6>
  ...
  },
  {
    title: 'Online Store',
    content:
      'Develop an online store of electronic devices for the provided layout, as well as develop a mobile version of it. The must be compatible with any ga.Develop an online store of electronic devices for the provided layout, as well as develop a mobile version of it. The must be compatible with any ga.',
    meta: '03:00PM',
    color: 'danger',
    customContent: (
