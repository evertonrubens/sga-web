...
const InvoicePreview = () => {
  ...
  return data !== null && data.invoice !== undefined ? (
    ...
    <Alert color='danger'>
      <h4 className='alert-heading'>Lançamento não encontrado</h4>
      <div className='alert-body'>
        lançamento com id: {id} não existe. Valide a lista de todos os lançamentos do dia: <Link to='/release/list'>Lista de Lançamentos</Link>
      </div>
    </Alert>
  )
}
