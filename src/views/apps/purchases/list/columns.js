...
const renderClient = row => {
  ...
  if (row.avatar.length) {
    ...
    return <Avatar color={color} className='mr-50' content={row.client ? row.client.name : 'Everton Martins'} initials />
  }
}
...
export const columns = [
  ...
  },
  {
    ...
    sortable: true,
    cell: row => {
      const name = row.client ? row.client.name : 'Everton Martins',
