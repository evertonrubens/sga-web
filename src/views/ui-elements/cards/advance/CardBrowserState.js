    ...
    <Card className='card-browser-states'>
      <CardHeader>
        <div>
          ...
          <CardText className='font-small-2'>Contadores de Março 2022</CardText>
        </div>
        <UncontrolledDropdown className='chart-dropdown'>
          ...
          <DropdownMenu right>
            <DropdownItem className='w-100'>Ultimos 28 Dias</DropdownItem>
            <DropdownItem className='w-100'>Ultimo Mês</DropdownItem>
            <DropdownItem className='w-100'>Ultimo Ano</DropdownItem>
          </DropdownMenu>
        </UncontrolledDropdown>
      </CardHeader>
