      ...
      <Row className='mx-0'>
        <Col className='revenue-report-wrapper' md='8' xs='12'>
          <div className='d-sm-flex justify-content-between align-items-center mb-3'>
            <CardTitle className='mb-50 mb-sm-0'>Relatório de Receita</CardTitle>
        ...
        <Col className='budget-wrapper' md='4' xs='12'>
          ...
          <div className='d-flex justify-content-center'>
            <span className='font-weight-bolder mr-25'>Orçamento:</span>
            <span>{data.budget}</span>
          </div>
          <Chart id='budget-chart' type='line' height='80' options={budgetOptions} series={budgetSeries} />
          <Button color='primary'>Aumentar Orçamento</Button>
        </Col>
      </Row>
    </Card>
  ) : null
