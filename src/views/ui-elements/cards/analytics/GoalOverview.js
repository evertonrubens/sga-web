...
const GoalOverview = props => {
  ...
  return data !== null ? (
    <Card>
      <CardHeader>
        <CardTitle tag='h4'>Visão Geral Meta</CardTitle>
      ...
      <Row className='border-top text-center mx-0'>
        <Col xs='6' className='border-right py-1'>
          <CardText className='text-muted mb-0'>Completada</CardText>
          <h3 className='font-weight-bolder mb-0'>{data.completed}</h3>
        </Col>
        <Col xs='6' className='py-1'>
          <CardText className='text-muted mb-0'>Em Progresso</CardText>
