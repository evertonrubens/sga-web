...
const Revenue = props => {
  ...
  return data !== null ? (
    <Card>
      <CardHeader>
        <CardTitle tag='h4'>Receita</CardTitle>
        <Settings size={18} className='text-muted cursor-pointer' />
      </CardHeader>
      <CardBody>
        <div className='d-flex justify-content-start mb-3'>
          <div className='mr-2'>
            <CardText className='mb-50'>Neste Mês</CardText>
            <h3 className='font-weight-bolder'>
              <sup className='font-medium-1 font-weight-bold mr-25'>R$</sup>
              <span className='text-primary'>180,589</span>
            </h3>
          </div>
          <div>
            <CardText className='mb-50'>Último Mês</CardText>
            <h3 className='font-weight-bolder'>
              <sup className='font-medium-1 font-weight-bold mr-25'>R$</sup>
              <span>130,683</span>
            </h3>
